    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/xereneas">
          <h2 class="name">Bittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/maheshsirop"><i class="fab fa-github"></i></a>
        <a href="https://t.me/xereneas"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
